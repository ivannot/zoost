...
| [`docs/usability.md`](docs/usability.md) | before changing first-run guidance, the sample path or the conversion funnel - the five-session protocol and the boundary between aggregate measurement and observation |
