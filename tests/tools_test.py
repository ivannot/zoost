...
class TheProbeSaysHowMuchItDrove(unittest.TestCase):
    ...
    those measured paths to 48 and 39 respectively, including workspace creation, folder-picker
    cancellation, local ER diagram controls and preview/detail navigation.
