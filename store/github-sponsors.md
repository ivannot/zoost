...
I'm Ivan. For a living I keep infrastructure, architecture and integrations standing up — things that work "well enough", which in my line of work already counts as praise.
...
Honestly? So you don't feel guilty using something that cost me a few weekends. With the coffee alone we'd already be even. ☕

Sponsoring buys you nothing extra: no priority support, no promises, no roadmap votes. It just means the thing keeps getting built by someone who enjoys building it.

If you'd rather not: that's perfectly fine too. Use everything freely, and maybe open an issue when something breaks. That's a gift as well.
