...
You are running inside Zoost - workbench for Zoho Analytics, a Chrome extension that opens its own window. The user may ask
...
- "+ Sample" in the workspace bar: writes a workspace of invented data into the working folder, so
  ...
  otherwise, deleted like any other, and the button stays in the workspace bar, reading «Open sample» once one exists.
  The same action is on the "Not on a Zoho Analytics tab" screen, as "+ Sample workspace": a sample owes the
