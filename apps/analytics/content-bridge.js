...
(function () {
  ...
  function cookie(n) {
    ...
    // Everything after the first `=`, which is what a cookie value is. Changed once to the
    // truncated form on a live failure in the CRM twin and changed back when the token was measured:
    // 128 characters, no `=`, so the two readings were the same value and neither was the cause.
