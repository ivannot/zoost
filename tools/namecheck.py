...
ALLOWED = {
    ...
    'apps/analytics/workbench.js': [
        ...
        # The sentences this panel shows on the twin's tab, and the title on its context-bar mark.
        # Its CRM counterpart lives in crm-context.js and is declared there: the same code, two
