...
CLOSED = {
    ...
    ("siblings", "diagrams", "diagram"): ("tests/panel.test.mjs: nothing counts a box the reader folded away "
                              ...
                              "planted 2026-08-23"),
    ("workspace", "crm-panel", "persist"): ("tests/panel.test.mjs derives every *Data/*Index", "planted 2026-08-22"),
    ("owner", "crm-panel", "pull"):     ("tests/panel.test.mjs derives every pull that reaches Zoho", "planted 2026-08-22"),
    ("siblings", "crm-panel", "pull"):  ("tests/panel.test.mjs derives every «press Pull» empty state", "planted 2026-08-22"),
    ("partial", "crm-panel", "persist"): ("tests/panel.test.mjs derives every folder-walking deletion", "planted 2026-08-22"),
    ("claim", "store", "*"):            ("tests/tools_test.py derives every numbered section from the headings", "planted 2026-08-22"),
    ("partial", "an-panel", "persist"): ("tests/panel.test.mjs: a prune's keep-set may not be optional", "planted 2026-08-22"),
    ("owner", "an-panel", "pull"):      ("tests/panel.test.mjs: a toggle released in a finally, everywhere", "planted 2026-08-22"),
    ("siblings", "an-panel", "pull"):   ("tests/panel.test.mjs: every control greyed by a verdict says why", "planted 2026-08-22"),
    ...
    ("fastpath", "an-panel", "search"): ("tests/panel.test.mjs: sqlBodyOf has one caller, the one that dates it", "planted 2026-08-22"),
    ("claim", "an-panel", "ai"):        ("tests/panel.test.mjs: every control the assistant is told about exists - limit stated in the check", "planted 2026-08-22"),
    ...
    ("fastpath", "crm-panel", "pull"):  ("tests/panel.test.mjs: an unread source measures as nothing, and nobody substitutes a number", "planted 2026-08-23"),
    ...
    ("silent", "diagrams", "diagram"):  ("tests/panel.test.mjs: a settings key written twice is merged; the window applies a kind-less default", "planted 2026-08-22"),
