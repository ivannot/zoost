...
SURFACES = [
    ("crm-panel",    "apps/crm/{sidepanel,workspace-controller,live-sync,preview-model,preview-controller,history-controller,report,overview-view,bridge-contract,pull-plan,pull-controller,pull-adapter,type-chips,pull-lifecycle,mirror-plan,error-model,tabs,modules,automation,connections,health,bootstrap}.js"),
