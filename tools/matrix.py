...
SURFACES = [
    ...
    ("an-panel",     "apps/analytics/{sidepanel,report,overview-view,bridge-contract,pull-lifecycle,pull-usecase,pull-adapter,mirror-plan,error-model,ai,export,health}.js"),
