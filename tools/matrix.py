...
SURFACE_FILES = {
    "crm-panel":  ["apps/crm/workbench.js", "apps/crm/workspace-controller.js", "apps/crm/live-sync.js", "apps/crm/preview-model.js", "apps/crm/preview-controller.js", "apps/crm/history-controller.js", "apps/crm/report.js", "apps/crm/overview-view.js", "apps/crm/bridge-contract.js", "apps/crm/pull-plan.js", "apps/crm/pull-controller.js", "apps/crm/pull-adapter.js", "apps/crm/type-chips.js", "apps/crm/function-stats.js", "apps/crm/graph-session.js", "apps/crm/crm-utils.js", "apps/crm/crm-pull-graph.js", "apps/crm/crm-download.js", "apps/crm/crm-failures.js", "apps/crm/pull-lifecycle.js", "apps/crm/mirror-plan.js", "apps/crm/error-model.js", "apps/crm/tabs.js", "apps/crm/modules.js",
                   "apps/crm/automation.js", "apps/crm/connections.js", "apps/crm/health.js", "apps/crm/bootstrap.js", "apps/crm/crm-search.js", "apps/crm/crm-navigation-ui.js", "apps/crm/crm-workflow-ui.js", "apps/crm/crm-tree.js", "apps/crm/crm-context.js", "apps/crm/crm-graph.js", "apps/crm/crm-bootstrap.js",
                   ...
                   "apps/crm/highlight.js", "apps/crm/sample-org.js",
                   "apps/crm/zoho-bridge.js", "apps/crm/zoho-navigation.js",
    ...
    "an-panel":   ["apps/analytics/workbench.js", "apps/analytics/report.js", "apps/analytics/overview-view.js", "apps/analytics/bridge-contract.js", "apps/analytics/pull-lifecycle.js", "apps/analytics/pull-usecase.js", "apps/analytics/pull-adapter.js", "apps/analytics/mirror-plan.js", "apps/analytics/error-model.js", "apps/analytics/ai.js",
                   ...
                   "apps/analytics/workspace.js", "apps/analytics/navigation.js",
                   "apps/analytics/search-state.js", "apps/analytics/list-model.js",
                   "apps/analytics/highlight.js", "apps/analytics/sample-org.js",
                   "apps/analytics/keyvault.js", "apps/analytics/product-help.js",
                   "apps/analytics/reportshell.js", "apps/analytics/bootstrap.js",
                   "apps/analytics/workbench.html", "apps/analytics/analytics-sql.js"],
    "options":    ["apps/crm/options.js", "apps/crm/options.html", "apps/crm/options-bridge.js",
                   "apps/analytics/options-bridge.js",
    ...
    "diagrams":   ["apps/crm/graphview.js", "apps/crm/graphlogic.js", "apps/crm/graph-core.js",
                   "apps/analytics/graphview.js",
                   "apps/analytics/graphlogic.js"],
...
SURFACES = [
    ("crm-panel",    "apps/crm/{workbench,workspace-controller,live-sync,preview-model,preview-controller,history-controller,report,overview-view,bridge-contract,pull-plan,pull-controller,pull-adapter,type-chips,function-stats,graph-session,crm-utils,crm-pull-graph,crm-download,crm-failures,crm-search,crm-navigation-ui,crm-workflow-ui,crm-tree,crm-context,crm-graph,crm-bootstrap,pull-lifecycle,mirror-plan,error-model,tabs,modules,automation,connections,health,bootstrap}.js"),
    ("crm-ai",       "apps/crm/{ai,keyvault}.js"),
    ("crm-export",   "apps/crm/{export-scope,export}.js"),
    ("an-panel",     "apps/analytics/{workbench,report,overview-view,bridge-contract,pull-lifecycle,pull-usecase,pull-adapter,mirror-plan,error-model,ai,export,health,bootstrap,analytics-view-model,analytics-mirror-writer}.js"),
